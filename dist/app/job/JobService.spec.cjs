...
describe("JobService", () => {
  describe("create()", () => {
    it("Should be able to create a job", () => __async(void 0, null, function* () {
      const dataMock = {
  ...
  describe("searchJobs()", () => {
    it("Should be able to filter jobs", () => __async(void 0, null, function* () {
  ...
  describe("favoriteJob()", () => {
    it("Should be able to favorite a job", () => __async(void 0, null, function* () {
      const userIdMock = "1";
      const jobIdMock = "1";
