...
var sut = new JobService(repositoryMock, techSearchRepositoryMock, userRepositoryMock);
describe("JobService", () => {
  describe("create()", () => {
  ...
  describe("filterJobs()", () => {
    it("Should be able to filter jobs", () => __async(exports, null, function* () {
      ...
      const result = yield sut.filterJobs(filtersMock, startIndexMock, itemsPerPageMock);
