...
describe("TechSearchService", () => {
  describe("registerTechSearch()", () => {
    it("Should be able to register a tech search", () => __async(void 0, null, function* () {
    ...
    it("Should return error when an exception is thrown", () => __async(void 0, null, function* () {
      const technologyMock = "JavaScript";
      const cityMock = "Belo Horizonte";
  ...
  describe("getTopTechnologies()", () => {
    it("Should be able to get top technologies", () => __async(void 0, null, function* () {
