...
var require_abbrev = __commonJS({
  "node_modules/abbrev/abbrev.js"(exports2, module2) {
    ...
    function abbrev(list) {
      ...
      for (var i2 = 0, l2 = list.length, args = []; i2 < l2; i2++) {
...
var require_nopt = __commonJS({
  "node_modules/nopt/lib/nopt.js"(exports2, module2) {
    ...
    function validate(data, k, val, type2, typeDefs) {
      if (Array.isArray(type2)) {
        for (var i2 = 0, l2 = type2.length; i2 < l2; i2++) {
          if (type2[i2] === Array)
            continue;
          if (validate(data, k, val, type2[i2], typeDefs))
            return true;
        }
        delete data[k];
        return false;
      ...
      for (var i2 = 0, l2 = types.length; i2 < l2; i2++) {
        debug("test type %j %j %j", k, val, types[i2]);
        var t = typeDefs[types[i2]];
      ...
      debug("OK? %j (%j %j %j)", ok, k, val, types[i2]);
      if (!ok)
        delete data[k];
      return ok;
    }
  ...
  "node_modules/string-width/index.js"(exports2, module2) {
    ...
    var stringWidth = (string3) => {
      ...
      for (let i2 = 0; i2 < string3.length; i2++) {
        const code = string3.codePointAt(i2);
  ...
  "node_modules/brace-expansion/index.js"(exports2, module2) {
    ...
    function expand(str, isTop) {
      ...
      if (isSequence) {
        ...
        N = [];
        for (var i2 = x; test3(i2, y2); i2 += incr) {
          var c;
          if (isAlphaSequence) {
  ...
  "node_modules/yallist/yallist.js"(exports2, module2) {
    ...
    Yallist.prototype.splice = function(start, deleteCount, ...nodes) {
      ...
      for (var i2 = 0; i2 < nodes.length; i2++) {
        walker = insert2(this, walker, nodes[i2]);
      }
      return ret;
    };
  ...
  return (hookContext) => {
    ...
    function next() {
      return __async(this, null, function* () {
        ...
        typeof value === "function" ? yield value(context, use2) : yield use2(value);
      });
    }
    return next();
  };
