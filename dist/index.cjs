  ...
  "node_modules/readable-stream/lib/_stream_writable.js"(exports, module2) {
    ...
    if (typeof Symbol === "function" && Symbol.hasInstance && typeof Function.prototype[Symbol.hasInstance] === "function") {
      ...
      Object.defineProperty(Writable, Symbol.hasInstance, {
        value: function value(object5) {
          if (realHasInstance.call(this, object5))
            return true;
          if (this !== Writable)
            return false;
          return object5 && object5._writableState instanceof WritableState;
        }
      });
    } else {
      realHasInstance = function realHasInstance2(object5) {
        return object5 instanceof this;
      };
    }
...
var require_strip_ansi = __commonJS({
  "node_modules/strip-ansi/index.js"(exports, module2) {
    ...
    module2.exports = (string5) => typeof string5 === "string" ? string5.replace(ansiRegex(), "") : string5;
  }
});
...
var require_error = __commonJS({
  "node_modules/gauge/error.js"(exports) {
    "use strict";
    var util = require("util");
    var User2 = exports.User = function User3(msg) {
      var err = new Error(msg);
      Error.captureStackTrace(err, User3);
      err.code = "EGAUGE";
      return err;
    };
    exports.MissingTemplateValue = function MissingTemplateValue(item, values) {
      var err = new User2(util.format('Missing template value "%s"', item.type));
...
var require_node_pre_gyp = __commonJS({
  "node_modules/@mapbox/node-pre-gyp/lib/node-pre-gyp.js"(exports, module2) {
    ...
    proto.package = require_package2();
    proto.configDefs = {
      help: Boolean,
      // everywhere
      arch: String,
...
var require_sign_stream = __commonJS({
  "node_modules/jws/lib/sign-stream.js"(exports, module2) {
    ...
    var util = require("util");
    function base64url(string5, encoding) {
      return Buffer2.from(string5, encoding).toString("base64").replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_");
    }
  ...
  "node_modules/lodash.includes/index.js"(exports, module2) {
    ...
    function baseKeys(object5) {
      ...
      for (var key in Object(object5)) {
        if (hasOwnProperty.call(object5, key) && key != "constructor") {
          result.push(key);
        }
      }
      return result;
    ...
    function values(object5) {
      return object5 ? baseValues(object5, keys(object5)) : [];
    }
...
var require_sign = __commonJS({
  "node_modules/jsonwebtoken/sign.js"(exports, module2) {
    ...
    function validate(schema, allowUnknown, object5, parameterName) {
      if (!isPlainObject(object5)) {
        throw new Error('Expected "' + parameterName + '" to be a plain object.');
      }
      Object.keys(object5).forEach(function(key) {
        ...
        if (!validator.isValid(object5[key])) {
...
var AuthMiddleware = class {
  static handler(req, res, next) {
    ...
    try {
      ...
      import_jsonwebtoken.default.verify(token, secretKey);
    } catch (erro) {
...
var { controller: controller2 } = AuthModule.getInstance();
authRoutes.post("/", controller2.login.bind(controller2));
...
var TechSearchModule = class {
  static getInstance() {
    ...
    const techSearchController2 = new TechSearchController(techSearchService);
    return { TechSearchRepository, techSearchService, techSearchController: techSearchController2 };
  }
};
