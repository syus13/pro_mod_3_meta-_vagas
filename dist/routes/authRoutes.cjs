...
var AuthModule = class {
  static getInstance() {
    ...
    const controller2 = new AuthController(service);
    return { userRepository, service, controller: controller2 };
  }
};

// src/routes/authRoutes.ts
var authRoutes = (0, import_express.Router)();
var { controller } = AuthModule.getInstance();
