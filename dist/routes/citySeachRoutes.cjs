...
var citySeachRoutes_exports = {};
__export(citySeachRoutes_exports, {
  citySearchRoutes: () => citySearchRoutes
});
module.exports = __toCommonJS(citySeachRoutes_exports);
...
// src/routes/citySeachRoutes.ts
var citySearchRoutes = (0, import_express.Router)();
var { controller } = CitySearchModule.getInstance();
