...
var jobRoutes_exports = {};
__export(jobRoutes_exports, {
  jobRoutes: () => jobRoutes
});
module.exports = __toCommonJS(jobRoutes_exports);
...
var JobModule = class {
  static getInstance() {
    ...
    const controller2 = new JobController(service);
...
var { controller } = JobModule.getInstance();
