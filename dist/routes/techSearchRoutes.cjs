...
var techSearchRoutes_exports = {};
__export(techSearchRoutes_exports, {
  techSearchRoutes: () => techSearchRoutes
});
module.exports = __toCommonJS(techSearchRoutes_exports);
...
// src/routes/techSearchRoutes.ts
var techSearchRoutes = (0, import_express.Router)();
